...
public class RequestParamController {
	 ...
	 *
	 * 주의! /request-param-required int age -> null을 int에 입력하는 것은 불가능, 따라서 Integer
	...
	/*
	 * @ModelAttribute 사용 참고: model.addAttribute(helloData) 코드도 함께 자동 적용됨, 뒤에 model
	 * 을 설명할 때 자세히 설명
	 */
	@ResponseBody
	 ...
	 * argument resolver로 지정해둔 타입(= HttpServletResponse 등) 외 = @ModelAttribute
	 */
	@ResponseBody
